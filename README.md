...
- **Monitoring**: cAdvisor, Grafana, Change Detection for observability
...
- **[Karakeep](karakeep/)** - Self-hosted bookmark and knowledge manager | [GitHub](https://github.com/karakeep/karakeep)
...
### Utilities & Tools
- **[Homepage](homepage/)** - Application dashboard and homepage | [GitHub](https://github.com/gethomepage/homepage)
...
- **Karakeep**: `https://karakeep.desktop.madhur.co.in`
...
### Utilities
- **Homepage**: `https://homepage.desktop.madhur.co.in`
...
- PostgreSQL runs on the host machine and is shared by multiple services:
  - Linkwarden, Gitea, and others connect to `local.madhur.co.in:5432`
